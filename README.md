...
work from a phone, continue a task, send images, preview linked source files, and bring generated files
back without exposing your computer to the public internet. Codex and project files remain on the
connector computer; a small relay you control provides the remote meeting point.
