...
<p align="center">
  <img src="docs/assets/readme-hero.png" alt="Codex Anywhere 可以通过手机浏览器查看并继续运行在自己电脑上的 Codex 会话" width="100%">
</p>
...
- **在手机取回结果**：预览发送或生成的图片、在线阅读回复中链接的 Markdown 文件及其中的 Mermaid
  图表，隔离打开 Codex 可视化，复制消息，并在确认后下载本机文件；下载时会尝试保持屏幕常亮，前台传输中断后可安全暂停
  并在重连时续传。
...
| 文件 | 受根目录限制的图片和 Markdown 预览、绑定已批准设备和单个文件的可续传下载，以及隔离可视化 |
